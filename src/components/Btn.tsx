...
export default function Btn({ children }: Props) {
  return (
    <button className="relative inline-flex h-10 overflow-hidden rounded-full p-[1px] focus:outline-none active:scale-95 group/btn transition-all duration-75 ease-out text-nowrap min-w-fit">
